...
```solidity
library IECDSATableCalculatorTypes {
...
pub mod IECDSATableCalculatorTypes {
    use super::*;
    ...
    /**Creates a new wrapper around an on-chain [`IECDSATableCalculatorTypes`](self) contract instance.

    See the [wrapper's documentation](`IECDSATableCalculatorTypesInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IECDSATableCalculatorTypesInstance<P, N> {
        IECDSATableCalculatorTypesInstance::<P, N>::new(address, provider)
    }
    /**A [`IECDSATableCalculatorTypes`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IECDSATableCalculatorTypes`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    #[derive(Clone)]
    pub struct IECDSATableCalculatorTypesInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IECDSATableCalculatorTypesInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IECDSATableCalculatorTypesInstance")
                .field(&self.address)
                .finish()
        }
    }
    ...
    impl<P: ::core::clone::Clone, N> IECDSATableCalculatorTypesInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IECDSATableCalculatorTypesInstance<P, N> {
            IECDSATableCalculatorTypesInstance {
...
interface IECDSATableCalculator {
    struct OperatorSet {
        address avs;
        uint32 id;
    }
    ...
    function calculateOperatorTable(OperatorSet memory operatorSet) external view returns (IECDSATableCalculatorTypes.ECDSAOperatorInfo[] memory operatorInfos);
...
[
    ...
    "outputs": [
      {
        "name": "operatorInfos",
        "type": "tuple[]",
        "internalType": "struct IECDSATableCalculatorTypes.ECDSAOperatorInfo[]",
        "components": [
          {
            "name": "pubkey",
            "type": "address",
  ...
  {
    "type": "event",
    "name": "LookaheadBlocksSet",
    "inputs": [
      {
        "name": "lookaheadBlocks",
        "type": "uint256",
        "indexed": false,
        "internalType": "uint256"
      }
...
pub mod IECDSATableCalculator {
    ...
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    /**Custom error with signature `LookaheadBlocksTooHigh()` and selector `0xdb037a70`.
    ```solidity
    error LookaheadBlocksTooHigh();
    ```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct LookaheadBlocksTooHigh;
    #[allow(
        non_camel_case_types,
        non_snake_case,
        clippy::pub_underscore_fields,
    ...
    const _: () = {
        ...
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<LookaheadBlocksTooHigh> for UnderlyingRustTuple<'_> {
            fn from(value: LookaheadBlocksTooHigh) -> Self {
                ()
            }
        }
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<UnderlyingRustTuple<'_>> for LookaheadBlocksTooHigh {
            fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                Self
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolError for LookaheadBlocksTooHigh {
            type Parameters<'a> = UnderlyingSolTuple<'a>;
            type Token<'a> = <Self::Parameters<'a> as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "LookaheadBlocksTooHigh()";
            const SELECTOR: [u8; 4] = [219u8, 3u8, 122u8, 112u8];
            #[inline]
            fn new<'a>(
    ...
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    /**Event with signature `LookaheadBlocksSet(uint256)` and selector `0xa41e64dd47db91b61b43ccea8b57d75abfa496f23efc708c22753c4bc9d68842`.
    ```solidity
    event LookaheadBlocksSet(uint256 lookaheadBlocks);
    ```*/
    #[allow(
    ...
    #[derive(Clone)]
    pub struct LookaheadBlocksSet {
        #[allow(missing_docs)]
        pub lookaheadBlocks: alloy::sol_types::private::primitives::aliases::U256,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        #[automatically_derived]
        impl alloy_sol_types::SolEvent for LookaheadBlocksSet {
            type DataTuple<'a> = (alloy::sol_types::sol_data::Uint<256>,);
            type DataToken<'a> = <Self::DataTuple<'a> as alloy_sol_types::SolType>::Token<'a>;
            type TopicList = (alloy_sol_types::sol_data::FixedBytes<32>,);
            const SIGNATURE: &'static str = "LookaheadBlocksSet(uint256)";
            const SIGNATURE_HASH: alloy_sol_types::private::B256 =
                alloy_sol_types::private::B256::new([
                    164u8, 30u8, 100u8, 221u8, 71u8, 219u8, 145u8, 182u8, 27u8, 67u8, 204u8, 234u8,
                    139u8, 87u8, 215u8, 90u8, 191u8, 164u8, 150u8, 242u8, 62u8, 252u8, 112u8,
                    140u8, 34u8, 117u8, 60u8, 75u8, 201u8, 214u8, 136u8, 66u8,
                ]);
        ...
        #[automatically_derived]
        impl alloy_sol_types::private::IntoLogData for LookaheadBlocksSet {
        ...
        #[automatically_derived]
        impl From<&LookaheadBlocksSet> for alloy_sol_types::private::LogData {
            #[inline]
            fn from(this: &LookaheadBlocksSet) -> alloy_sol_types::private::LogData {
                alloy_sol_types::SolEvent::encode_log_data(this)
            }
        }
    };
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    /**Function with signature `calculateOperatorTable((address,uint32))` and selector `0x124c87e0`.
    ```solidity
    function calculateOperatorTable(OperatorSet memory operatorSet) external view returns (IECDSATableCalculatorTypes.ECDSAOperatorInfo[] memory operatorInfos);
    ```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct calculateOperatorTableCall {
        #[allow(missing_docs)]
        pub operatorSet: <OperatorSet as alloy::sol_types::SolType>::RustType,
    }
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`calculateOperatorTable((address,uint32))`](calculateOperatorTableCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct calculateOperatorTableReturn {
        #[allow(missing_docs)]
        pub operatorInfos: alloy::sol_types::private::Vec<
            <IECDSATableCalculatorTypes::ECDSAOperatorInfo as alloy::sol_types::SolType>::RustType,
        >,
    }
    #[allow(
        non_camel_case_types,
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<calculateOperatorTableCall> for UnderlyingRustTuple<'_> {
                fn from(value: calculateOperatorTableCall) -> Self {
                    (value.operatorSet,)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for calculateOperatorTableCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {
                        operatorSet: tuple.0,
                    }
        ...
        }
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> = (
                alloy::sol_types::sol_data::Array<IECDSATableCalculatorTypes::ECDSAOperatorInfo>,
            );
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<calculateOperatorTableReturn> for UnderlyingRustTuple<'_> {
                fn from(value: calculateOperatorTableReturn) -> Self {
                    (value.operatorInfos,)
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for calculateOperatorTableReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {
                        operatorInfos: tuple.0,
                    }
                }
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for calculateOperatorTableCall {
            ...
            const SIGNATURE: &'static str = "calculateOperatorTable((address,uint32))";
            const SELECTOR: [u8; 4] = [18u8, 76u8, 135u8, 224u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
            ...
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<alloy::sol_types::sol_data::Array<
                    IECDSATableCalculatorTypes::ECDSAOperatorInfo,
            ...
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
                    |r| {
                        let r: calculateOperatorTableReturn = r.into();
                        r.operatorInfos
                    },
                )
            }
    ...
    ///Container for all the [`IECDSATableCalculator`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum IECDSATableCalculatorCalls {
        #[allow(missing_docs)]
        calculateOperatorTable(calculateOperatorTableCall),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl IECDSATableCalculatorCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[
            ...
            [18u8, 76u8, 135u8, 224u8],
            [65u8, 238u8, 109u8, 14u8],
            [113u8, 202u8, 113u8, 217u8],
        ];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IECDSATableCalculatorCalls {
        const NAME: &'static str = "IECDSATableCalculatorCalls";
        const MIN_DATA_LENGTH: usize = 64usize;
        const COUNT: usize = 4usize;
        #[inline]
        fn selector(&self) -> [u8; 4] {
            match self {
                Self::calculateOperatorTable(_) => {
                    <calculateOperatorTableCall as alloy_sol_types::SolCall>::SELECTOR
                }
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IECDSATableCalculatorCalls>] = &[
                {
                    fn getOperatorWeight(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IECDSATableCalculatorCalls> {
                        <getOperatorWeightCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IECDSATableCalculatorCalls::getOperatorWeight)
                    }
                    getOperatorWeight
                },
                {
                    fn calculateOperatorTable(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IECDSATableCalculatorCalls> {
                        <calculateOperatorTableCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            data,
                        )
                        .map(IECDSATableCalculatorCalls::calculateOperatorTable)
                    }
                ...
                },
                {
                    fn calculateOperatorTableBytes(
                        ...
                        <calculateOperatorTableBytesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IECDSATableCalculatorCalls::calculateOperatorTableBytes)
                    }
                ...
                },
                {
                    fn getOperatorWeights(
                        ...
                        <getOperatorWeightsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IECDSATableCalculatorCalls::getOperatorWeights)
                    }
                    getOperatorWeights
                },
            ];
            ...
            >] = &[
                ...
                },
                {
                    fn calculateOperatorTable(
                        ...
                        <calculateOperatorTableCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IECDSATableCalculatorCalls::calculateOperatorTable)
                    }
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                Self::calculateOperatorTable(inner) => {
                    <calculateOperatorTableCall as alloy_sol_types::SolCall>::abi_encoded_size(
                        inner,
                    )
                }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                Self::calculateOperatorTable(inner) => {
                    <calculateOperatorTableCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner, out,
                    )
                }
                Self::calculateOperatorTableBytes(inner) => {
    ...
    ///Container for all the [`IECDSATableCalculator`](self) custom errors.
    #[derive(serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq, Hash)]
    pub enum IECDSATableCalculatorErrors {
        #[allow(missing_docs)]
        LookaheadBlocksTooHigh(LookaheadBlocksTooHigh),
    }
    #[automatically_derived]
    impl IECDSATableCalculatorErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
        ///
        /// Prefer using `SolInterface` methods instead.
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[219u8, 3u8, 122u8, 112u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IECDSATableCalculatorErrors {
        const NAME: &'static str = "IECDSATableCalculatorErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        const COUNT: usize = 1usize;
        #[inline]
        fn selector(&self) -> [u8; 4] {
            match self {
                Self::LookaheadBlocksTooHigh(_) => {
                    <LookaheadBlocksTooHigh as alloy_sol_types::SolError>::SELECTOR
                }
            }
        }
        #[inline]
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IECDSATableCalculatorErrors>] = &[{
                fn LookaheadBlocksTooHigh(
                    data: &[u8],
                ) -> alloy_sol_types::Result<IECDSATableCalculatorErrors> {
                    <LookaheadBlocksTooHigh as alloy_sol_types::SolError>::abi_decode_raw(data)
                        .map(IECDSATableCalculatorErrors::LookaheadBlocksTooHigh)
                }
                LookaheadBlocksTooHigh
            }];
            let Ok(idx) = Self::SELECTORS.binary_search(&selector) else {
                return Err(alloy_sol_types::Error::unknown_selector(
                    <Self as alloy_sol_types::SolInterface>::NAME,
        ...
        fn abi_decode_raw_validate(
            ...
            >] = &[{
                fn LookaheadBlocksTooHigh(
                    ...
                    <LookaheadBlocksTooHigh as alloy_sol_types::SolError>::abi_decode_raw_validate(
                        data,
                    )
                    .map(IECDSATableCalculatorErrors::LookaheadBlocksTooHigh)
                }
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                Self::LookaheadBlocksTooHigh(inner) => {
                    <LookaheadBlocksTooHigh as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
            }
        }
        #[inline]
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                Self::LookaheadBlocksTooHigh(inner) => {
                    <LookaheadBlocksTooHigh as alloy_sol_types::SolError>::abi_encode_raw(
                        inner, out,
                    )
                }
            }
    ...
    ///Container for all the [`IECDSATableCalculator`](self) events.
    #[derive(serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq, Hash)]
    pub enum IECDSATableCalculatorEvents {
        #[allow(missing_docs)]
        LookaheadBlocksSet(LookaheadBlocksSet),
    }
    #[automatically_derived]
    impl IECDSATableCalculatorEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
        ...
        pub const SELECTORS: &'static [[u8; 32usize]] = &[[
            164u8, 30u8, 100u8, 221u8, 71u8, 219u8, 145u8, 182u8, 27u8, 67u8, 204u8, 234u8, 139u8,
            87u8, 215u8, 90u8, 191u8, 164u8, 150u8, 242u8, 62u8, 252u8, 112u8, 140u8, 34u8, 117u8,
            60u8, 75u8, 201u8, 214u8, 136u8, 66u8,
        ]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IECDSATableCalculatorEvents {
        const NAME: &'static str = "IECDSATableCalculatorEvents";
        const COUNT: usize = 1usize;
        fn decode_raw_log(
            ...
            match topics.first().copied() {
                Some(<LookaheadBlocksSet as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <LookaheadBlocksSet as alloy_sol_types::SolEvent>::decode_raw_log(topics, data)
                        .map(Self::LookaheadBlocksSet)
                }
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IECDSATableCalculatorEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::LookaheadBlocksSet(inner) => {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IECDSATableCalculator`](self) contract instance.

    See the [wrapper's documentation](`IECDSATableCalculatorInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IECDSATableCalculatorInstance<P, N> {
        IECDSATableCalculatorInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IECDSATableCalculatorInstance<P, N>>>
    {
        IECDSATableCalculatorInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IECDSATableCalculatorInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IECDSATableCalculator`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IECDSATableCalculator`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IECDSATableCalculatorInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IECDSATableCalculatorInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IECDSATableCalculatorInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IECDSATableCalculatorInstance<P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IECDSATableCalculatorInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IECDSATableCalculatorInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IECDSATableCalculatorInstance<P, N> {
            IECDSATableCalculatorInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
        ...
        IECDSATableCalculatorInstance<P, N>
    {
        ...
        ///Creates a new call builder for the [`calculateOperatorTable`] function.
        pub fn calculateOperatorTable(
            &self,
            operatorSet: <OperatorSet as alloy::sol_types::SolType>::RustType,
        ) -> alloy_contract::SolCallBuilder<&P, calculateOperatorTableCall, N> {
            self.call_builder(&calculateOperatorTableCall { operatorSet })
        }
        ...
        IECDSATableCalculatorInstance<P, N>
    {
        ...
        ///Creates a new event filter for the [`LookaheadBlocksSet`] event.
        pub fn LookaheadBlocksSet_filter(
            &self,
        ) -> alloy_contract::Event<&P, LookaheadBlocksSet, N> {
            self.event_filter::<LookaheadBlocksSet>()
        }
    }
}
