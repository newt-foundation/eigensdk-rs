...
```solidity
library IBN254TableCalculatorTypes {
...
pub mod IBN254TableCalculatorTypes {
    use super::*;
    use alloy::sol_types as alloy_sol_types;
    #[derive(serde::Serialize, serde::Deserialize, Default, Debug, PartialEq, Eq, Hash)]
    /**```solidity
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IBN254TableCalculatorTypes`](self) contract instance.

    See the [wrapper's documentation](`IBN254TableCalculatorTypesInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IBN254TableCalculatorTypesInstance<P, N> {
        IBN254TableCalculatorTypesInstance::<P, N>::new(address, provider)
    }
    /**A [`IBN254TableCalculatorTypes`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IBN254TableCalculatorTypes`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IBN254TableCalculatorTypesInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IBN254TableCalculatorTypesInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IBN254TableCalculatorTypesInstance")
                .field(&self.address)
                .finish()
        }
    }
    ...
    impl<P: ::core::clone::Clone, N> IBN254TableCalculatorTypesInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IBN254TableCalculatorTypesInstance<P, N> {
            IBN254TableCalculatorTypesInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
...
interface IBN254TableCalculator {
    struct OperatorSet {
        address avs;
        uint32 id;
    }

    function calculateOperatorTable(OperatorSet memory operatorSet) external view returns (IBN254TableCalculatorTypes.BN254OperatorSetInfo memory operatorSetInfo);
    ...
    function getOperatorInfos(OperatorSet memory operatorSet) external view returns (IBN254TableCalculatorTypes.BN254OperatorInfo[] memory operatorInfos);
    ...
    "outputs": [
      {
        ...
        "type": "tuple",
        "internalType": "struct IBN254TableCalculatorTypes.BN254OperatorSetInfo",
        "components": [
          {
...
pub mod IBN254TableCalculator {
    ...
    pub struct calculateOperatorTableReturn {
        #[allow(missing_docs)]
        pub operatorSetInfo: <IBN254TableCalculatorTypes::BN254OperatorSetInfo as alloy::sol_types::SolType>::RustType,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        ...
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> = (IBN254TableCalculatorTypes::BN254OperatorSetInfo,);
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <IBN254TableCalculatorTypes::BN254OperatorSetInfo as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(_t: alloy_sol_types::private::AssertTypeEq<UnderlyingRustTuple>) {
        ...
        impl alloy_sol_types::SolCall for calculateOperatorTableCall {
            ...
            type Return = <IBN254TableCalculatorTypes::BN254OperatorSetInfo as alloy::sol_types::SolType>::RustType;
            type ReturnTuple<'a> = (IBN254TableCalculatorTypes::BN254OperatorSetInfo,);
            ...
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (
                    <IBN254TableCalculatorTypes::BN254OperatorSetInfo as alloy_sol_types::SolType>::tokenize(
                        ret,
                    ),
                )
            }
    ...
    pub struct getOperatorInfosReturn {
        ...
        pub operatorInfos: alloy::sol_types::private::Vec<
            <IBN254TableCalculatorTypes::BN254OperatorInfo as alloy::sol_types::SolType>::RustType,
        >,
    }
    #[allow(
        non_camel_case_types,
    ...
    const _: () = {
        ...
        }
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> = (
                alloy::sol_types::sol_data::Array<IBN254TableCalculatorTypes::BN254OperatorInfo>,
            );
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
    ...
    ///Container for all the [`IBN254TableCalculator`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    pub enum IBN254TableCalculatorCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl IBN254TableCalculatorCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IBN254TableCalculatorCalls {
        const NAME: &'static str = "IBN254TableCalculatorCalls";
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<IBN254TableCalculatorCalls>] = &[
                {
                    fn getOperatorWeight(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IBN254TableCalculatorCalls> {
                        <getOperatorWeightCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IBN254TableCalculatorCalls::getOperatorWeight)
                    }
                    getOperatorWeight
                },
                {
                    fn calculateOperatorTable(
                        ...
                        .map(IBN254TableCalculatorCalls::calculateOperatorTable)
                    }
                ...
                },
                {
                    fn calculateOperatorTableBytes(
                        ...
                        <calculateOperatorTableBytesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IBN254TableCalculatorCalls::calculateOperatorTableBytes)
                    }
                ...
                },
                {
                    fn getOperatorWeights(
                        ...
                        <getOperatorWeightsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IBN254TableCalculatorCalls::getOperatorWeights)
                    }
                    getOperatorWeights
                },
                {
                    fn getOperatorInfos(
                        ...
                        <getOperatorInfosCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IBN254TableCalculatorCalls::getOperatorInfos)
                    }
                    getOperatorInfos
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IBN254TableCalculator`](self) contract instance.

    See the [wrapper's documentation](`IBN254TableCalculatorInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IBN254TableCalculatorInstance<P, N> {
        IBN254TableCalculatorInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IBN254TableCalculatorInstance<P, N>>>
    {
        IBN254TableCalculatorInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IBN254TableCalculatorInstance::<P, N>::deploy_builder(provider)
    }
    /**A [`IBN254TableCalculator`](self) instance.

    Contains type-safe methods for interacting with an on-chain instance of the
    [`IBN254TableCalculator`](self) contract located at a given `address`, using a given
    provider `P`.
    ...
    See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IBN254TableCalculatorInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IBN254TableCalculatorInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IBN254TableCalculatorInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IBN254TableCalculatorInstance<P, N>
    {
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IBN254TableCalculatorInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IBN254TableCalculatorInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IBN254TableCalculatorInstance<P, N> {
            IBN254TableCalculatorInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
        ...
        IBN254TableCalculatorInstance<P, N>
    {
        ...
        pub fn getOperatorInfos(
            ...
            self.call_builder(&getOperatorInfosCall { operatorSet })
        }
