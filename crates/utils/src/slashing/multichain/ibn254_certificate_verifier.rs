            ...
            >] = &[
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IBN254CertificateVerifierCalls>
                    {
                        <calculateCertificateDigestCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IBN254CertificateVerifierCalls::calculateCertificateDigest,
                            )
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IBN254CertificateVerifierCalls>
                    {
                        <getOperatorCountCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IBN254CertificateVerifierCalls::getOperatorCount)
                    }
                    getOperatorCount
                },
                {
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IBN254CertificateVerifierCalls>
                    {
                        <getTotalStakeWeightsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IBN254CertificateVerifierCalls::getTotalStakeWeights)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IBN254CertificateVerifierCalls>
                    {
                        ...
                        .map(IBN254CertificateVerifierCalls::isReferenceTimestampSet)
                    }
            ...
            >] = &[
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IBN254CertificateVerifierErrors>
                    {
                        ...
                        .map(IBN254CertificateVerifierErrors::NonSignerIndicesNotSorted)
                    }
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<IBN254CertificateVerifierErrors>
                    {
                        <NonSignerIndicesNotSorted as alloy_sol_types::SolError>::abi_decode_raw_validate(
                            ...
                            .map(
                                IBN254CertificateVerifierErrors::NonSignerIndicesNotSorted,
                            )
                    }
                    NonSignerIndicesNotSorted
                },
