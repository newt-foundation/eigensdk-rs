...
interface IEigenPodManager {
    ...
    function increaseBurnOrRedistributableShares(OperatorSet memory operatorSet, uint256 slashId, address strategy, uint256 addedSharesToBurn) external;
...
pub mod IEigenPodManager {
    ...
    impl alloy_sol_types::SolInterface for IEigenPodManagerCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls>] = &[
                ...
                },
                {
                    fn increaseBurnOrRedistributableShares(
                        ...
                        <increaseBurnOrRedistributableSharesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(
                                IEigenPodManagerCalls::increaseBurnOrRedistributableShares,
                            )
                    }
                    increaseBurnOrRedistributableShares
                },
                {
                    fn addShares(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn version(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                        <versionCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IEigenPodManagerCalls::version)
                    }
                    version
                },
                {
                    fn pauseAll(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn paused_1(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn ethPOS(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn createPod(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn stake(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn ownerToPod(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn getPod(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn numPods(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn hasPod(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
                ...
                {
                    fn unpause(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerCalls> {
    ...
    impl alloy_sol_types::SolInterface for IEigenPodManagerErrors {
        ...
        #[allow(non_snake_case)]
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IEigenPodManagerErrors>] =
                &[
                    {
                    ...
                    },
                    {
                        ...
                        ) -> alloy_sol_types::Result<IEigenPodManagerErrors>
                        {
                            ...
                            .map(IEigenPodManagerErrors::LegacyWithdrawalsNotCompleted)
                        }
        ...
        fn abi_decode_raw_validate(
            ...
            >] = &[
                ...
                {
                    fn OnlyPauser(data: &[u8]) -> alloy_sol_types::Result<IEigenPodManagerErrors> {
    ...
    >(
        ...
        provider: P,
    ) -> IEigenPodManagerInstance<P, N> {
        IEigenPodManagerInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IEigenPodManagerInstance<P, N>>>
    {
        IEigenPodManagerInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IEigenPodManagerInstance::<P, N>::deploy_builder(provider)
    }
    ...
    #[derive(Clone)]
    pub struct IEigenPodManagerInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IEigenPodManagerInstance<P, N> {
        #[inline]
        ...
        IEigenPodManagerInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IEigenPodManagerInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IEigenPodManagerInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IEigenPodManagerInstance<P, N> {
